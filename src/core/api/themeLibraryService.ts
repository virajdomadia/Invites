...
export const createTheme = async (
  ...
  try {
    ...
    console.error('[ThemeLibraryService] Failed to create theme:', errorMsg);
    return {
      status: 0,
      error: errorMsg,
    };
...
export const getTheme = async (
  ...
  try {
    ...
    const errorMsg = extractErrorMessage(err);
    console.error('[ThemeLibraryService] Failed to fetch theme:', errorMsg);
    return {
      status: 0,
      error: errorMsg,
    };
...
export const listThemes = async (
  ...
  try {
    ...
    const errorMsg = extractErrorMessage(err);
    console.error('[ThemeLibraryService] Failed to list themes:', errorMsg);
    return {
      data: [],
      total: 0,
      limit: params?.limit ?? 50,
...
export const updateTheme = async (
  ...
  try {
    ...
    const errorMsg = extractErrorMessage(err);
    console.error('[ThemeLibraryService] Failed to update theme:', errorMsg);
    return {
      status: 0,
      error: errorMsg,
    };
...
export const deleteTheme = async (
  ...
  try {
    ...
    const errorMsg = extractErrorMessage(err);
    console.error('[ThemeLibraryService] Failed to delete theme:', errorMsg);
    return {
      status: 0,
      error: errorMsg,
    };
